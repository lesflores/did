...
# Esta interacción solo tomará el valor de 1 si el hogar estaba inscrito y ya estamos en el periodo posterior a la intervención. Si alguna de estas dos condiciones no se cumple, es decir, 
# si el hogar no estaba inscrito o si estamos en un momento previo al programa, el valor de la interacción será 0. Esto nos ayuda a aislar el efecto real del programa.
